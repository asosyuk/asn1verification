...
Inductive TYPE_descriptor :=
 ...
 primitive decoders\footnote{This is a simplified definition. In the actual implementation, we will use stream monad for input and monadic error handling.}. In \emph{ASN1C}, it is implemented as a recursive
