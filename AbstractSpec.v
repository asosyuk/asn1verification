...
Require Import Core.Core Core.Notations Core.Tactics Lib.Types.
...
Inductive Prim_Integer : list byte -> list byte -> Prop :=
  | Prim_Int ls : Prim_Integer ls ls.
...
Definition BER_Prim_Integer := Prim_Integer.
Definition DER_Prim_Integer := BER_Prim_Integer.
...
| Prim_Integer_short_BER t v z :
    PrimitiveTag t ->
    len v = 1 ->
    BER_Prim_Integer z v ->
    BER (PRIM_INTEGER z) (t ++ [Byte.one] ++ v) 

| Prim_Integer_long_BER t l v z:
    PrimitiveTag t ->
...
| Prim_Integer_short_DER t v z :
    PrimitiveTag t ->
    len v = 1 ->
    DER_Prim_Integer z v ->
    DER (PRIM_INTEGER z) (t ++ [Byte.one] ++ v) 

| Prim_Integer_long_DER t l v z:
    PrimitiveTag t ->
    DefiniteLength (len v) l ->
    1 < len v ->
    v#1 <> all_one ->
